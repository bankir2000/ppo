  ...
  , jc = {
    ...
    data() {
        return {
            ...
            disclosure: ["\u0410\u043A\u0443\u0441\u0442\u0438\u0447\u043D\u043E", "\u0412\u0456\u0437\u0443\u0430\u043B\u044C\u043D\u043E", "\u0410\u043a\u0443\u0441\u0442\u0438\u0447\u043d\u043e \u0442\u0430 \u0432\u0456\u0437\u0443\u0430\u043b\u044c\u043d\u043e \u043d\u0435 \u0432\u0438\u044f\u0432\u043b\u0435\u043d\u043e"],
    ...
    computed: {
        dataForClipboard() {
            return {
                ...
                text: (this.form.time ? "" + this.form.time + " " : "") + (this.form.sign ? ` ${this.form.sign}` : "") + (this.form.nearestCity ? ` \u0432 \u0440\u0430\u0439\u043E\u043D\u0456 \u043D.\u043F. ${this.form.nearestCity}` : "") + (this.form.target ? ` ${this.form.target}` : "") + (this.form.target_side ? ` (${this.form.target_side})` + " " : ``) + (this.form.target_description ? ` ${this.form.target_description}` + " " : "") + (this.form.tcil ? " \u0426\u0456\u043B\u044C: " + this.form.tcil + " " : "") + (this.form.disclosure ? "\u0020\u0412\u0438\u044F\u0432: " + this.form.disclosure + " " : "") + (this.form.number_of_targets ? `\u0020\u041A\u0456\u043B\u044C\u043A\u0456\u0441\u0442\u044C: ${this.form.number_of_targets}\u043E\u0434. ` : "") + (this.form.azimuth ? `\u0020\u0410-${this.form.azimuth}\xB0` : "") + (this.form.direction ? `\u0020\u041A- ${this.form.direction}\xB0` : "") + (this.form.height ? `\u0020\u041D- ${this.form.height}\u043C. ` : "") + (this.form.distance ? `\u0020\u0414- ${this.form.distance}\u043C.` : "") + (this.form.target_action ? "" + this.form.target_action + " " : "") + (this.form.ammunition_consumption ? "\u0412\u0438\u0442\u0440\u0430\u0442\u0438 \u0411\u041a \u0417\u041a ЗУ MR2 VIKTOR 14,5мм=" + this.form.ammunition_consumption +  "шт. (в т.ч. БЗТ-" + Math.round(this.form.ammunition_consumption / 4) + "шт., МДЗ-" + (this.form.ammunition_consumption - Math.round(this.form.ammunition_consumption / 4)) + "шт.)." + " " : "") + (this.form.ak_ammunition_consumption ? "\u0412\u0438\u0442\u0440\u0430\u0442\u0438 \u0411\u041a \u0410\u041a74-5.45mm=" + this.form.ak_ammunition_consumption + "шт (в т.ч. ТЗ-" + Math.round(this.form.ak_ammunition_consumption / 3) + "шт., ПС-" + (this.form.ak_ammunition_consumption-Math.round(this.form.ak_ammunition_consumption / 3)) + "шт.)." + `` : "") + (this.form.dshk_ammunition_consumption ? "\u0412\u0438\u0442\u0440\u0430\u0442\u0438 \u0411\u041a \u0414\u0428\u041a-12.7mm=" + this.form.dshk_ammunition_consumption + "шт. " : "") + (this.form.browning_ammunition_consumption ? "\u0412\u0438\u0442\u0440\u0430\u0442\u0438 \u0411\u041a Browning M2-12.7mm=" + this.form.browning_ammunition_consumption + "шт. " : "") + (this.form.pkm_ammunition_consumption ? "\u0412\u0438\u0442\u0440\u0430\u0442\u0438 \u0411\u041a \u041f\u041a\u041c-7.62mm=" + this.form.pkm_ammunition_consumption + "шт. " : "") + (this.form.m75_ammunition_consumption ? "\u0412\u0438\u0442\u0440\u0430\u0442\u0438 M75-20.0mm=" + this.form.m75_ammunition_consumption + "шт. " : "") + (this.form.description ? " " + this.form.description + `` : "")
