    ...
    computed: {
        dataForClipboard() {
            return {
                ...
                text: (this.form.time ? "" + this.form.time + " " : "") + (this.form.sign ? ` ${this.form.sign}` : "") + (this.form.nearestCity ? `\u043D.\u043F. ${this.form.nearestCityЇ}` : "") + (this.form.target ? ` ${this.form.target}` : "") + (this.form.target_side ? ` (${this.form.target_side})
` : `
