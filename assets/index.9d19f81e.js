  ...
  , jc = {
    ...
    data() {
        return {
            ...
            watchId: null,
            targets: ["БпЛА типу Гербера", "БпЛА типу Зала", "БпЛА типу Молнія", "БпЛА типу Невизначений", "БпЛА типу Орлан", "БпЛА типу Суперкам", "БпЛА типу ШАХЕД", "Вибух.", "Вибух на землі", "Виходи.", "Гелікоптер.", "Зонд", "Квадрокоптер.", "Крилата Ракета.", "Літак Великий.", "Літак Малий.", "Постріли.", "Спалах в небі", "FPV-дрон"],
