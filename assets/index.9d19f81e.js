    ...
    computed: {
        dataForClipboard() {
            return {
                ...
                text: (this.form.time ? "" + this.form.time + " " : "") + (this.form.sign ? ` ${this.form.sign}` : "") + (this.form.nearestCity ? `\u0020\u043D.\u043F. ${this.form.nearestCity}` : "") + (this.form.target ? ` ${this.form.target}` : "") + (this.form.target_side ? ` (${this.form.target_side})` : ``) + (this.form.target_description ? ` ${this.form.target_description}` : "") + (this.form.number_of_targets ? `\u041A\u0456\u043B\u044C\u043A\u0456\u0441\u0442\u044C: ${this.form.number_of_targets}\u043E\u0434. ` : "") + (this.form.azimuth ? `\u0020\u0410-${this.form.azimuth}\xB0` : "") + (this.form.direction ? `\u0020\u041A- ${this.form.direction}\xB0` : "") + (this.form.height ? `\u0020\u041D- ${this.form.height}\u043C. ` : "") + (this.form.distance ? `\u0020\u0414- ${this.form.distance}\u043C.` : "") + (this.form.disclosure ? "\u0412\u0438\u044F\u0432: " + this.form.disclosure + " " : "") + (this.form.tcil ? "\u0426\u0456\u043B\u044C: " + this.form.tcil + " " : "") + (this.form.target_action ? "" + this.form.target_action + " " : "") + (this.form.ammunition_consumption ? "\u0420\u043e\u0437\u0445\u0456\u0434 \u0411\u041a \u0417\u041a Victor KPVT-14.5=" + this.form.ammunition_consumption +  "шт (в т.ч. БЗТ-" + Math.round(this.form.ammunition_consumption / 4) + "шт, МДЗ-" + (this.form.ammunition_consumption - Math.round(this.form.ammunition_consumption / 4)) + "шт)" + " " : "") + (this.form.ak_ammunition_consumption ? "\u0420\u043e\u0437\u0445\u0456\u0434 \u0411\u041a \u0410\u041a74 5.45-" + this.form.ak_ammunition_consumption + "шт (в т.ч. ТЗ-" + Math.round(this.form.ak_ammunition_consumption / 3) + "шт, ПС-" + (this.form.ak_ammunition_consumption-Math.round(this.form.ak_ammunition_consumption / 3)) + "шт)" + `` : "") + (this.form.description ? "\u041E\u043F\u0438\u0441: " + this.form.description + `` : "")
